...
class EpargneService
{
    ...
    public static function collecter(Vente $vente, Recouvrement $recouvrement): void
    {
        ...
        if ($mouvement) {
            ComptabiliteService::ecrireEpargneCollecte($epargne, $mouvement);
        }
    }
